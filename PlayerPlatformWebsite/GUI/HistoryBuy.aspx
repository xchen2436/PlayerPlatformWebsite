<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="HistoryBuy.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.History" %>
...
<body>
    <form id="form1" runat="server">
 	<header>
        ...
        <div>
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Sell History" CssClass="btnT"/>
            </div><br/><br/>
