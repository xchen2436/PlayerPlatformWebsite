<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileChangeItemInfoCOCUnapproved.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.ProfileChangeItemInfoCOCUnapproved" %>
    ...
    <form id="form1" runat="server">
 	<header>
        ...
        <p>
            ...
            <br>
            <asp:Button ID="ButtonNext" runat="server" OnClick="ButtonNext_Click" Text="Update" CssClass="btnEmailFormSave"/>
        </p>
    </form><br><br><br><br><br>
    </body>
       <footer id="footer">
