<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="BuyLOL.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.BuyLOL" %>
    ...
    <form id="form1" runat="server">
 	<header>
        ...
        <div>
            ...
            <asp:Label ID="Label1" runat="server" ForeColor="Black" CssClass="server">Server</asp:Label>
        <asp:DropDownList ID="DropDownList2" runat="server">
            ...
            <asp:Button ID="ButtonSearch" runat="server" OnClick="ButtonSearch_Click" autopostback="false" Text="Search" CssClass="btn" style="margin-left:15px;"/>
