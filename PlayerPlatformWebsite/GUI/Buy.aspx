<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.Buy" %>
    ...
    <form id="form1" runat="server">
 	<header>
        ...
        <div>
            ...
            <asp:Label ID="LabelTitle" runat="server" Text="Choose one of the game you want to buy" CssClass="labelTitle"></asp:Label>
            </div>
        <p>
            ...
            <asp:ImageButton ID="ImageButtonFIFA" runat="server" BorderColor="Blue" BorderStyle="Outset" Height="250px" ImageAlign="AbsMiddle" ImageUrl="~/Image/GameIcon/FIFA-22.jpeg" Width="250px" CssClass="imagebtn" OnClick="ImageButtonFIFA_Click"/>
