<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.Payment" %>
...
<body>
    <form id="form1" runat="server">
 	<header>
        ...
        <br/>
         <div>
            <asp:HyperLink NavigateUrl="ChooseCard.aspx" runat="server" CssClass="Hyper" ID="HyperLink1" ForeColor="Black">↩Back</asp:HyperLink>
            </div>
        <br/>
        ...
        <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="rb">
            ...
            <asp:Button ID="ButtonPurchase" runat="server" OnClick="ButtonPurchase_Click" Text="Purchase" CssClass="btn"/>
        <br/><br/>
    </form><br/><br/><br/><br/><br/>
    </body>
       <footer id="footer">
