<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyCOCDetail.aspx.cs" Inherits="PlayerPlatformWebsite.GUI.BuyCOCDetail" %>
...
<body>
    <form id="form1" runat="server">
 	<header>
        ...
        <br>
            <div>
            <asp:HyperLink NavigateUrl="BuyCOC.aspx" runat="server" CssClass="Hyper" ID="HyperLink1" ForeColor="Black" Font-Bold="true" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">↩Back</asp:HyperLink>
            </div>
        <p>
            ...
            <asp:Label ID="Label3" runat="server" Text="Town Hall Level: " CssClass="lbl"></asp:Label>
            <asp:TextBox ID="TextBoxTHLevel" runat="server"  CssClass="txtNewEmail"> </asp:TextBox><br>
            <asp:Label ID="Label4" runat="server" Text="Current Gem: " CssClass="lbl"></asp:Label>
